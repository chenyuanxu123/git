...
<body>
    ...
    <script type="text/javascript">
	    ...
	    $(function(){
	    	$("#tree").tree({
	    		lines:true,
	    		url:"${pageContext.request.contextPath }/menuInfo/menuList.action",
	    ...
	    function openTabs(node){
    		if($("#tabs").tabs("exists",node.text)){
    			...
    			var context="<iframe class='page-iframe' src='${pageContext.request.contextPath }/html/"+node.attributes.path+"' frameborder='no'   border='no' height='100%' width='100%' scrolling='auto'></iframe>";
    			$("#tabs").tabs("add",{
    				title:node.text,
